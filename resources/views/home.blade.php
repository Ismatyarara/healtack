...
<head>
  ...
  <link rel="stylesheet" href="{{asset('UI/vendors/ti-icons/css/themify-icons.css')}}">
  <link rel="stylesheet" type="text/css" href="{{asset('UI/js/select.dataTables.min.css')}}">
...
<body>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="{{asset('UI/images/dashboard/people.svg')}}" alt="people">
  ...
  <script src="{{asset('UI/js/dataTables.select.min.js')}}"></script>
